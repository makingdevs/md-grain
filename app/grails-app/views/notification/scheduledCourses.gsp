...
<head>
  ...
  <style type="text/css">
    ...
    @media only screen and (max-width: 640px) {
      ...
      /* Head  */
      .HeaderTable { background-color:black; width:440px !important; margin:0 auto !important; }
    ...
    @media only screen and (max-width: 479px)  {
      ...
      /* Head  */
      .HeaderTable { background-color:black; width:280px !important; margin:0 auto !important; }
      ...
      /* Hide  */
      .RespoHide { display:none !important; } 
      .footer-table {border-spacing: 0px;}
      #primero { 
                              ...
                              <tr>
                                ...
                                <td rowspan="2">
                                  <table>
                                    <tr>
                                      <td height="30px"></td>
                                      <td height="420px" bgcolor="#d2e6f4" width="300">
                                        <p id="primero" align="justify" style="border:9px solid #d2e6f4;">La mente, por ejemplo, es   considerada por muchos como un fenómeno emergente ya que surge de la interacción distribuida entre  diversos procesos neuronales (incluyendo también algunos corporales y del entorno) sin que pueda  reducirse a ninguno de los componentes que participan en el proceso (ninguna de las neuronas por separado es consciente). </p>  
                                      </td>
                                      <td height="35"></td>
                                    </tr>
                                  </table>
