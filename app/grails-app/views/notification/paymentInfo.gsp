...
.SizeHeadTable img {  width:580px !important; height:230px !important; }
              ...
              <tr>
                <td width="580">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" align="left" >
                    ...
                    <tr>
                      <td height="50">
                        <a href="#"><img editable="true"  mc:edit="logo" src="${grailsApplication.config.grails.serverURL}/mail/img/logo.jpg" alt="" border="0"></a>
                      </td>
                    </tr>
                    <tr>
              ...
              <tr>
                ...
                <td width="560">
                    ...
                    <table width="560" class="HeadWrap" border="0" cellpadding="0" cellspacing="0" align="center">
                     ...
                     <tr>
                         <td class="HeadTitle">
                         <a href="#"  mc:edit="Head_Title" style=" font-size:16px; font-weight:800; font-family: Helvetica, Arial, sans-serif; text-decoration: none; color: #45484e"><multiline><span style="color:#4f9dd3;">Instrucciones para realizar tu pago</span></multiline></a>
                ...
                <td>
                     ...
                     <table  width="60%" border="0" cellpadding="0" cellspacing="0" align="left" class="CtaTitle">
                             ...
                             <table   border="0" cellpadding="0" cellspacing="0" align="left" class="CtaTitle">
                                  <tr>
                                  <td>
                                 <a href="http://makingdevs.com" mc:edit="ctatitle"  class="CtaTitleW" style="text-decoration: none; color: #45484E"><multiline>¿Quieres saber <span style="color:#4f9dd3;">más</span> de nosotros?</multiline></a>
                                  </td>
                                  </tr>
                             </table>
                               </td>
